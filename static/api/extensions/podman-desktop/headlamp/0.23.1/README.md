...
<div align="center">
  <img src="images/headlamp_quick_run.gif" width="80%">
</div>
...
<table>
    <tr>
        <td width="33%"><img src="images/home.png"></td>
        <td width="33%"><img src="images/cluster_chooser.png"></td>
    </tr>
    <tr>
        <td width="33%"><img src="images/workloads.png"></td>
        <td width="33%"><img src="images/resource_edition.png"></td>
    </tr>
    <tr>
        <td width="33%"><img src="images/logs.png"></td>
        <td width="33%"><img src="images/terminal.png"></td>
    </tr>
</table>
...
We maintain a list of the [Kubernetes platforms](https://github.com/headlamp-k8s/headlamp/blob/main/docs/platforms.md) we have
...
Check out our [guidelines](https://headlamp.dev/docs/latest/contributing/), including our [Code of Conduct](https://github.com/headlamp-k8s/headlamp/blob/main/CODE_OF_CONDUCT.md),
